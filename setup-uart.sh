...
echo "Set the TRI_STATE_ALL to low before doing any changes"
...
echo "mode1 is used to set the UART interface in Edison"
...
echo "Set the TRI_STATE_ALL to high after the changes are applied"
